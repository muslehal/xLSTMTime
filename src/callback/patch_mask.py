...
#    """
#    seq_len = xb.shape[1]
#    original_num_patch = (max(seq_len, patch_len) - patch_len) // stride + 1

#    # Find the largest divisor of 256 that is less than or equal to original_num_patch
#    for num_patch in range(min(256, original_num_patch), 0, -1):
#        if 256 % num_patch == 0:
#            break

#    # Adjust the stride to accommodate the new number of patches
#    if num_patch < original_num_patch:
#        stride = (seq_len - patch_len) // (num_patch - 1)
